"""sitehealth CLI dispatch: `sitehealth crawl ...` | `sitehealth sitemap ...`."""
import sys

USAGE = """sitehealth — SEO site-health checks

usage:
  sitehealth crawl   <url> [--max-pages N] [--depth N] [--timeout S] [--report-file F]
  sitehealth sitemap <url> [--sitemap URL] [--timeout S] [--no-check] [--report-file F]
...
def main(argv=None):
    ...
    if argv[0] in ("-V", "--version"):
        ...
        print(f"sitehealth {__version__}")
        return 0
